...
const (
	CharsetBlend  = "1234567890ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz"
	CharsetDigit  = "1234567890"
	CharsetLetter = "abcdefghijklmnopqrstuvwxyz"
	CharsetZnCn   = "的一了是我不在人们有来他这上着个地到大里说去子得也和那要下看天时过出小么起你都把好还多没为又可家学只以主会样年想能生同老中从自面前" +
...
func CaptchaString() string {
	return BlendString(6)
}
